...
public:
    ...
    void SetDragStartPosition(double x, double y) { _dragStartX = x; _dragStartY = y; }
    void GetDragStartPosition(double& x, double& y) const { x = _dragStartX; y = _dragStartY; }
...
private:
    ...
    */
    ...
    double _dragStartX;          // ドラッグ開始時のウィンドウX座標
    double _dragStartY;          // ドラッグ開始時のウィンドウY座標
